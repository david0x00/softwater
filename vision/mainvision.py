...
#change to webcam or live camera instead of video?  What is going to be the input for the actual robot?
cap = cv2.VideoCapture("vision/test_video.mp4")
